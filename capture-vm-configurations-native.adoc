...
+
プランニングセンターが表示されます。計画センターから、VM インベントリ データをアップロードし、以前のインベントリ データのアップロードを確認し、任意の VM インベントリ データセットを使用して移行を計画できます。次に、[*AWS ネイティブ コンピューティングへの移行*] を選択します。VMware 移行アドバイザーのスプラッシュ スクリーンが表示されます。
