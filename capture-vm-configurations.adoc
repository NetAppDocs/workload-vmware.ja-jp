...
. [VMware]タイルで、*[計画と導入]*を選択します。
+
image:screenshot-choose-method.png["現在のVM構成情報の収集に使用できるさまざまな方法のスクリーンショット。"]
...
+
詳細については、『』の「コマンドラインパラメータ」の章を参照してください https://resources.robware.net/resources/prod/RVTools.pdf["RVToolsのマニュアル"^] 。
...
====
.次の手順
link:launch-onboarding-advisor.html["移行アドバイザを使用して導入計画を作成"]です。
