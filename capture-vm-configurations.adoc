...
. VMware メニューから、*評価と計画* を選択し、*VMware Cloud on AWS への移行* を選択します。
+
VMware Migration Advisorのメインページが表示されます。

. *VMC の計画と作成*を選択します。
. *始めましょう！*を選択します。チェックボックスを選択すると、このページを再度表示しないようにすることができます。
...
+
「コマンドラインパラメータ」の章を参照してください。 https://www.dell.com/en-us/shop/vmware/sl/rvtools["リソースセクションのRVToolsドキュメント"^] 詳細については。
